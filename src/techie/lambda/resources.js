...
module.exports = {
  ...
  en: {
    translation: {
      ...
      GENERIC_REPROMPT: 'Sorry, I didn\'t catch that, would you like to tell me which part of your body hurts, for example you can say "My neck hurts"?',
      PROMPT_FOR_ACTION: 'Ok. What would you like to do? You can ask for exercise for the body part such as "My neck hurts"',
      REPROMPT_FOR_ACTION: 'Sorry, I didn\'t catch that, what would you like to do? You can say "My neck hurts"',
      HELP_PROMPT: 'Techie buddy is your best buddy for short exercise during your busy schedule. You can say "I don\'t feel comfortable"',
